...
- Eliminates the need to store long-lived AWS access keys in GitHub secrets.
- Restricts deployment access to specific repositories, branches, and workflows through role trust policies.
- Improves auditability by tying role assumption and deployment activity to short-lived CI identities.
